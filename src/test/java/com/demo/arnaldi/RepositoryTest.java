...
public class RepositoryTest {
	...
	@Test
	public void givenGitHubRepoResponseEntityWhenSaveWithGitHubRepoResponseRepositoryThenSouldSaveToDB() {
		...
		//when
		GitHubRepoResponseEntity actualGitHubRepoResponseEntity = gitHubRepoResponseRepository.save(gitHubRepoResponseEntity);
		
		//then
		
		assertEquals(gitHubRepoResponseEntity, actualGitHubRepoResponseEntity);
	}
